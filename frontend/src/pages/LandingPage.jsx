...
export default function LandingPage() {
  ...
  const faqList = [
    ...
    },
    {
      ...
      a: "Your scores are based on the number of correct answers you give during the test.",
    },
  ];

  // =============== Google AdSense hook (call after render) ===============
  useEffect(() => {
    try {
    ...
    <>
      ...
      <Box sx={{ bgcolor: "#f7f9fc", minHeight: "100vh" }}>
        ...
        <Container maxWidth="lg" sx={{ py: { xs: 6, md: 10 } }}>
          ...
          {/* ========= GOOGLE ADSENSE BLOCK (BLENDED UNDER HERO) ========= */}
          <Box sx={{ width: "100%", textAlign: "center", my: 5 }}>
            ...
            <ins
              ...
              style={{ display: "block" }}
              data-ad-client="ca-pub-5185850033939140"
              data-ad-slot="9276107830"
              data-ad-format="auto"
              ...
              <Card variant="outlined" sx={{ borderRadius: 3 }}>
                <CardContent>
                  <Stack direction="row" justifyContent="space-between">
                    ...
                    <Button href="/leaderboard" size="small">
                      View all
                    </Button>
                  </Stack>
